//burada giriş bilgileri kontrolü yapılacak
//taskların listesi tutulacak
...
class TaskBloc {
  ...
  Future<Null> _updateTasks(String apiKey) async {
    _tasks = await _repository.addUserTasks(apiKey);
  }
}
...
class Repository {
  signinUser(String username, String password, String apiKey) {}
}
